function betas=LD(ira, bParams)
warning('off','all')

% Apply polar Legendre decompostion
%
% Inputs:
%  ira      - a 2d triangular array (polar) of the raw data folded
%                 to (0,pi/2) - G(R,alpha) generated by tripol.m
...
%
% Outputs:
%  betas      - a matrix containing each beta_n(r) such that positive
%               orderes are normalized by beta_0 (intesity(r)),for example: 
%               betas(1,:) is beta_0(r), 
%               betas(2,:) is beta_2(r)/beta_0(r), 
%               betas(3,:) is beta_4(r)/beta_0(r), ...
%
%            
%   Ver 1.11 (2018-10-01)
...
% TO DO:
% add rebinning control in radius and angle seperatly
